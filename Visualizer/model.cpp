...
double Model::bearing() const
{
  return m_data.bearing;
}

double Model::brake() const
{
  return m_data.brake;
}

double Model::steeringAngle() const
{
  return m_data.steeringAngle;
}

double Model::throttle() const
{
...
double Model::latg() const
{
  return m_data.latg;
}

Model::Data Model::data() const
{
  return m_data;
}
...
void
Model::setData(const Model::Data &data)
{
